...
public class SendVoteToOne implements CommandExecutor {
        ...
        if (sender instanceof Player) {
            ...
            if (args.length == 1) {
                ...
                if (args[0].equals(String.valueOf(questionNumber))) {
                    ...
                    ArrayList<Player> optionOneVotes = OptionVotes.getOptionOneVotes();
                    ...
                    if (votedPlayers.contains(player)) {
                        ...
                        optionOneVotes.add(player);
                        player.sendMessage(ChatColor.GREEN + "Successfully voted for option one");
